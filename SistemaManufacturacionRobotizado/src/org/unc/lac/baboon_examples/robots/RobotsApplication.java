...
public class RobotsApplication implements BaboonApplication {
	...
	public void subscribe() {
		try {
			BaboonFramework.subscribeToTopic("M4.processFromI3", m4, "processPiece", i3);
			BaboonFramework.subscribeToTopic("M3.processFromI3", m3, "processPiece", i3);
			
			BaboonFramework.subscribeToTopic("M3.processFromI1", m3, "processPiece", i1);
			BaboonFramework.subscribeToTopic("M4.processFromI1", m4, "processPiece", i1);
			
			BaboonFramework.subscribeToTopic("M1.processFromI1", m1, "processPiece", i1);
			BaboonFramework.subscribeToTopic("M2.processFromI1", m2, "processPiece", i1);
			
			BaboonFramework.subscribeToTopic("M2.processFromI2", m2, "processPiece", i2);
			
			BaboonFramework.subscribeToTopic("R3.moveFromI3ToM4", r3, "movePiece", i3,m4);
			BaboonFramework.subscribeToTopic("R2.moveFromM4ToM3", r2, "movePiece", m4,m3);
			BaboonFramework.subscribeToTopic("R1.moveFromM3ToO3", r1, "movePiece", m3,o3);
			
			BaboonFramework.subscribeToTopic("R1.moveFromI1ToM3", r1, "movePiece", i1,m3);
			BaboonFramework.subscribeToTopic("R2.moveFromM3ToM4", r2, "movePiece", m3,m4);
			BaboonFramework.subscribeToTopic("R3.moveFromM4ToO1", r3, "movePiece", m4,o1);
			
			BaboonFramework.subscribeToTopic("R1.moveFromI1ToM1", r1, "movePiece", i1,m1);
			BaboonFramework.subscribeToTopic("R2.moveFromM1ToM2", r2, "movePiece", m1,m2);
			BaboonFramework.subscribeToTopic("R3.moveFromM2ToO1", r3, "movePiece", m2,o1);
			
			BaboonFramework.subscribeToTopic("R2.moveFromI2ToM2", r2, "movePiece", i2,m2);
			BaboonFramework.subscribeToTopic("R2.moveFromM2ToO2", r2, "movePiece", m2,o2);
